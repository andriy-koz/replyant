...
5. **Describe the operating environment.** Tell the agent how its output reaches users, [what systems it connects to](/lab/anatomy-of-ai-agent-mcp/), and what could go wrong in the data it processes. For a practical example of how these principles translate into real configuration, see how [hooks, plugins, and CLAUDE.md files](/lab/claude-code-in-production/) implement governance in Claude Code.
